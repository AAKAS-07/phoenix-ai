// Comprehensive official mapping of all 28 Indian States and 8 Union Territories with their corresponding districts

export const INDIAN_STATES_DISTRICTS = {
  "Andhra Pradesh": [
    "Anantapur", "Chittoor", "East Godavari", "Guntur", "Krishna", "Kurnool",
    "Prakasam", "Srikakulam", "Visakhapatnam", "Vizianagaram", "West Godavari",
    "YSR Kadapa", "Anakapalli", "Bapatla", "Eluru", "Kakinada", "Nandyal", "Palnadu"
  ],
  "Arunachal Pradesh": [
    "Changlang", "Dibang Valley", "East Kameng", "East Siang", "Itanagar", "Kamle",
...
export const getDistrictsForState = (stateName) => {
  ...
  // Normalized case-insensitive lookup fallback
  const normalizedSearch = stateName.trim().toLowerCase();
  const matchedKey = Object.keys(INDIAN_STATES_DISTRICTS).find(
    key => key.toLowerCase() === normalizedSearch
  );

  return matchedKey ? INDIAN_STATES_DISTRICTS[matchedKey] : [];
};
